...
# Se uma árvore utópica é plantada com um metro no final do outono, qual
...
# E assim por diante...
# Defina a função “altura_arvore_utopica”, que recebe a altura inicial da árvore
#  utópica plantada no final do outono e a quantidade de ciclos de crescimento, e
#      que retorne a altura resultante após a quantidade de ciclos de crescimento
#       informada.
# Valide a altura inicial (que não pode ser zero ou menor) e a quantidade de 
# ciclos (que não pode ser negativo). Caso a validação falhar, a função deve 
# retornar nil.
